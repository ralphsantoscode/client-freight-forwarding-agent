...
! function(t, e) {
    ...
    }), g.fn[E] = H._jQueryInterface, g.fn[E].Constructor = H, g.fn[E].noConflict = function() {
        ...
        ut = function() {
            ...
            return t.next = function() {
                ...
                if (this._touchSupported) {
                    var e = function(t) {
                            n._pointerEvent && ht[t.originalEvent.pointerType.toUpperCase()] ? n.touchStartX = t.originalEvent.clientX : n._pointerEvent || (n.touchStartX = t.originalEvent.touches[0].clientX)
                        },
                        i = function(t) {
                            n._pointerEvent && ht[t.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = t.originalEvent.clientX - n.touchStartX), n._handleSwipe(), "hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function(t) {
                                return n.cycle(t)
    ...
    var ft = "collapse",
        ...
        wt = function() {
            ...
            return t.toggle = function() {
                ...
                var t, e, n = this;
                if (!this._isTransitioning && !g(this._element).hasClass(Et) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Dt)).filter(function(t) {
                    ...
                    if (g(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        g(this._element).removeClass(yt).addClass(Ct), this._element.style[o] = 0, this._triggerArray.length && g(this._triggerArray).removeClass(Tt).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                            s = _.getTransitionDurationFromElement(this._element);
                        g(this._element).one(_.TRANSITION_END, function() {
                            g(n._element).removeClass(Ct).addClass(yt).addClass(Et), n._element.style[o] = "", n.setTransitioning(!1), g(n._element).trigger(vt.SHOWN)
                ...
                if (!this._isTransitioning && g(this._element).hasClass(Et)) {
                    ...
                    if (g(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", _.reflow(this._element), g(this._element).addClass(Ct).removeClass(yt).removeClass(Et);
                        var i = this._triggerArray.length;
                        if (0 < i)
                            for (var o = 0; o < i; o++) {
                                var r = this._triggerArray[o],
                                    s = _.getSelectorFromElement(r);
                                if (null !== s) g([].slice.call(document.querySelectorAll(s))).hasClass(Et) || g(r).addClass(Tt).attr("aria-expanded", !1)
                            }
                        this.setTransitioning(!0);
                        this._element.style[n] = "";
                        var a = _.getTransitionDurationFromElement(this._element);
                        g(this._element).one(_.TRANSITION_END, function() {
                            t.setTransitioning(!1), g(t._element).removeClass(Ct).addClass(yt).trigger(vt.HIDDEN)
                ...
                return this.each(function() {
                    ...
                    if (!e && n.toggle && "string" == typeof i && /show|hide/.test(i) && (n.toggle = !1), e || (e = new a(this, n), t.data(dt, e)), "string" == typeof i) {
                ...
                if (void 0 === t && (t = !1), !(this._element.disabled || g(this._element).hasClass(Ht) || g(this._menu).hasClass(Rt))) {
                    ...
                    if (g(i).trigger(n), !n.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            ...
                            var o = this._element;
                            "parent" === this._config.reference ? o = i : _.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && g(i).addClass(qt), this._popper = new u(o, this._menu, this._getPopperConfig())
                        }
        ...
        Te = function() {
            ...
            return t.toggle = function(t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    g(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), g(this._element).on(le.CLICK_DISMISS, Ee, function(t) {
                        return e.hide(t)
    ...
    var un = "scrollspy",
        ...
        On = function() {
            ...
            return t.refresh = function() {
                ...
                n.hasClass(vn) ? (n.closest(Dn).find(wn).addClass(En), n.addClass(En)) : (n.addClass(En), n.parents(Cn).prev(Tn + ", " + Sn).addClass(En), n.parents(Cn).prev(bn).children(Tn).addClass(En)), g(this._scrollElement).trigger(pn.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function() {
